...
void Game::LoadTheResources()
{
    ...
    character.createEntity("Player", 0.5, 0.5, 1, WINDOW_MAX_WIDTH, WINDOW_MAX_HEIGHT, renderer, "./resources/textures/poro.jpg");
    ...
    dmgtxt.init("small_town.ttf", 48, White, WINDOW_MAX_WIDTH, WINDOW_MAX_HEIGHT);
    dmgtxt.setAscend(0.004); // Sets the speed the text ascend
    dmgtxt.setFade(2); // Set the text fade speed
}
