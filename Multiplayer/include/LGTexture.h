...
class LGTexture
{
    public:
        ...
        #ifdef _SDL_TTF_H
        bool loadFromRenderedText( std::string textureText, SDL_Renderer* Rend, TTF_Font* font, SDL_Color textColor);
        #endif // _SDL_TTF_H
        ...
        void render( SDL_Renderer* LGRenderer, int x, int y, float scale = 1, SDL_Rect* clip = NULL, double angle = 0.0,
