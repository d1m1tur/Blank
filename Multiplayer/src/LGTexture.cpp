...
#ifdef _SDL_TTF_H
bool LGTexture::loadFromRenderedText( std::string textureText, SDL_Renderer* Rend, TTF_Font* font, SDL_Color textColor)
{
...
void LGTexture::render(SDL_Renderer* LGRenderer, int x, int y, float scale, SDL_Rect* srcrect, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
